...
| Fichier | `index.html` (~1,1 Mo, ~17 354 lignes) |
...
🌿 **Profil** — Infos personnelles, culture (pot/pleine terre), données de la collection, export/import JSON, toggle ETP expert, bouton verrouiller.
